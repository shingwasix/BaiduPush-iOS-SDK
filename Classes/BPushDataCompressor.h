...
// This is a helper class used by BPushHTTPRequest to handle deflating (compressing) data in memory and on disk
...
@interface BPushDataCompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
